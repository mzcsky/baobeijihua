...
- (id)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        volumnIndicator.backgroundColor = [UIColor colorWithRed:234/255.0 green:166/255.0 blue:31/255.0 alpha:1];
...
- (void)updateLayout:(NSTimer *)timer {
    ...
    self.time = (int)([NSDate timeIntervalSinceReferenceDate] - startTimestamp);
}
